%%%%%%
% function model3: bayesian model for nonlinear/nonparametric process, 
% uncertain data, and without limiting or bounding dates
...
%%%%%%
function [Y,TEE,GAMMA,LAMBDA,PHI,YPOST,YRATE,tpost,s,z,zet,sig,ind]=model3(kernNum)
